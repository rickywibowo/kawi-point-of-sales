...
- Frontend API client foundation, login/session UX, module navigation shell, module table/action foundation, dan action drawer foundation tersedia.

Tahap terkait: 1, 9, 14, 15, 31, 32, 33, 34, 35.

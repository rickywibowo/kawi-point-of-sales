...
- Frontend API client foundation dan login/session UX tersedia.

Tahap terkait: 1, 9, 14, 15, 31, 32.
...
- Frontend UX lanjutan: module pages, forms, dan table views nyata.
